 ...
 * @author Smartec
 */
public class GenShareCert extends javax.swing.JFrame implements Printable{
    ...
    private void initComponents() {
        ...
        jTextFieldtenthousand.setBounds(280, 190, 40, 20);
        ...
        jTextFieldac.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextFieldac.setText("100451");
        jTextFieldac.setBorder(null);
        ...
        jComboBoxtype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Transaction", "Bonus Share", "Yearly", "Total" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jTextFieldac, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jTextFielddate, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
try{// create a PDF Printer Job
    	 ...
    	 printer.print("12345.pdf");
          PrintRequestAttributeSet aset = new HashPrintRequestAttributeSet();  
 
        FileInputStream inputStream = null;
   
        try {
            inputStream = new FileInputStream("12345.pdf");
 ...
 PrintService printService=PrintServiceLookup.lookupDefaultPrintService();
    ...
    writer.append("Not printed 12345.pdf");
   ...
   if(evt.getClickCount()==2)
   {
    ...
    try {
     ...
     con = DriverManager.getConnection(
        "jdbc:derby://localhost:1527/license","sa","Admin123Server");
      Statement stmt = con.createStatement(); 
     
      //selecting rows
      ResultSet current=stmt.executeQuery("select * from certno");
      if(current.next()){
     certno=Integer.parseInt(current.getString("certno"));
     certno=certno+1;
    ...
    stmt.executeUpdate("update certno set certno='"+certno+"'");
     ...
     JOptionPane.showMessageDialog(this,"Exception: "+e.getMessage()); 
      ...
      StrQuery="select ac_no,abs(amount) amount,name from memtrans inner join customer on cust_no=ac_no "
             + "where ac_no='"+jTextFieldac.getText()+"' and gl_no='"+jTextFieldgl.getText()+"' and ses_date='"+jTextFielddate.getText()+"'";
       }
       else if(jComboBoxtype.getSelectedItem().toString().equalsIgnoreCase("Bonus Share")){
      StrQuery="select ac_no,abs(amount) amount,name from memtrans inner join customer on cust_no=ac_no "
             + "where ac_no='"+jTextFieldac.getText()+"' and gl_no='"+jTextFieldgl.getText()+"' and ses_date='"+jTextFielddate.getText()+"'";
       }
             ...
             + "where ac_no='"+jTextFieldac.getText()+"' and gl_no='"+jTextFieldgl.getText()+"' and ses_date between '"
                   + ""+jTextFielddate.getText().substring(0,4)+"-01-01' and '"+jTextFielddate.getText().substring(0,4)+"-12-31'"
                     + " group by ac_no,name";
   
       }else{
            StrQuery="select ac_no,SUM(abs(amount)) amount,name from memtrans inner join customer on cust_no=ac_no "
             + "where ac_no='"+jTextFieldac.getText()+"' and gl_no='"+jTextFieldgl.getText()+"'"
                  + " group by ac_no,name";
       }
    glob = new Global();
...
if(jComboBoxtype.getSelectedItem().toString().equalsIgnoreCase("Bonus Share")){
 ...
 //end of checking for Bonus share
 //checking for the period to cover e.g by transaction,yearly and total
if(!jComboBoxtype.getSelectedItem().toString().equalsIgnoreCase("Transaction")){
...
//JOptionPane.showMessageDialog(rootPane, certno);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GenShareCert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new GenShareCert().setVisible(true); 
            }
        });
    }
    ...
    public javax.swing.JTextField jTextFieldac;
