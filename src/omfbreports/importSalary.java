 ...
 */
public class importSalary extends javax.swing.JFrame {
...
Global glob = new Global();
 if(i<1){ FileDialog fd = new FileDialog(this,"Import Salary Excel File in .XLSX Format",FileDialog.LOAD); // begin of if stmt
 fd.setFile("*.xlsx");
 fd.setVisible(true);
...
//String Whttranctno=dtt.substring(2, 4)+dtt.substring(5, 7)+dtt.substring(8)+Rnum+trannoCnt+"WHT#";
               ...
               String sql3="insert into memtrans(branch,gl_no,ac_no,trx_no,ses_date,batch_date,amount,err_flag,fin_repo,fx_amount) values(100,'"+glno+"','"+acno+"','"+ tranctno+"','"+dtt+" 00:00:00.000','"+dtt+" 00:00:00.000','"+BigDecimal.valueOf(Double.parseDouble(amount.replaceAll(",", ""))).negate()+"','','1','0.00')"; 
                 String sql4;
               if (acno.equalsIgnoreCase("1") && glno.equalsIgnoreCase("202999")){
                String suspensename=jTablecust.getModel().getValueAt(n, 1).toString();
                
                suspensename=jLabeltrantext.getText().concat(" IFO "+suspensename);
                if(suspensename.length()>50) {suspensename=suspensename.substring(0,49);}
                 sql4="insert into trx_text(branch,trx_no,cheque,teller,trx_code,text,username ,ses_date,fx_code,SUPER_USER) values(100,'"+ tranctno+"','','','FIB','"+suspensename+"','SYSTEM','"+dtt+" 00:00:00.000','0','NULL')";

                }
                else {
                sql4="insert into trx_text(branch,trx_no,cheque,teller,trx_code,text,username ,ses_date,fx_code,SUPER_USER) values(100,'"+ tranctno+"','','','FIB','"+jLabeltrantext.getText()+"','SYSTEM','"+dtt+" 00:00:00.000','0','NULL')";
                }    
...
jButtonpost.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(importSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new importSalary().setVisible(true);
            }
        });
    }
